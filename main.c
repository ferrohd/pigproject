...
int main(void) { 
	...
	printf("----START CALCULATING IRRIGATION TIME----\n\n");
...
float watering_multiplier(int weather_id, int time, int wind_incidence, float wind_direction) {
	...
	if ((weather_id >= 200) && (weather_id <= 232) && (wind_incidence_function(wind_direction, time))) {
		if (weather_id == 200) { //THUNDERSTORM WITH LIGHT RAIN
			printf("Weather is: THUNDERSTORM WITH LIGHT RAIN\n");
			return 0.70;
		}
		if (weather_id == 201) {
			printf("Weather is: THUNDERSTORM WITH RAIN\n");//THUNDERSTORM WITH RAIN
			return 0.50;
		}
		if (weather_id == 202) { //THUNDERSTORM WITH HEAVY RAIN
			printf("Weather is: THUNDERSTORM WITH HEAVY RAIN\n");
			return 0.25;
		}
		if (weather_id == 210) { //LIGHT THUNDERSTORM
			printf("Weather is: LIGHT THUNDERSTORM\n");
			return 0.90;
		}
		if (weather_id == 211) { //THUNDERSTORM
			printf("Weather is: THUNDERSTORM\n");
			return 0.80;
		}
		if (weather_id == 212) { //HEAVY THUNDERSTORM
			printf("Weather is: HEAVY THUNDERSTORM\n");
			return 0.60;
		}
		if (weather_id == 221) { //RUGGED THUNDERSTORM (Temporale irregolare)
			printf("Weather is: RUGGED THUNDERSTORM\n");
			return 0.70;
		}
		if (weather_id == 230) { //THUNDERSTORM WITH LIGHT DRIZZLE
			printf("Weather is: THUNDERSTORM WITH LIGHT DRIZZLE\n");
			return 0.80;
		}
		if (weather_id == 231) { //THUNDERSTORM WITH DRIZZLE
			printf("Weather is: THUNDERSTORM WITH DRIZZLE\n");
			return 0.70;
		}
		if (weather_id == 232) { //THUNDERSTORM WITH HEAVY DRIZZLE
			printf("Weather is: THUNDERSTORM WITH HEAVY DRIZZLE\n");
			return 0.55;
		}
	}
	...
	if ((weather_id >= 300) && (weather_id <= 321) && (wind_incidence_function(wind_direction, time))) {
		if (weather_id == 300) { //LIGHT INTENSITY DRIZZLE
			printf("Weather is: LIGHT INTENSITY DRIZZLE\n");
			return 0.90;
		}
		if (weather_id == 301) { //DRIZZLE
			printf("Weather is: DRIZZLE\n");
			return 0.80;
		}
		if (weather_id == 302) { //HEAVY INTENSITY DRIZZLE
			printf("Weather is: HEAVY INTENSITY DRIZZLE\n");
			return 0.50;
		}
		if (weather_id == 310) { //LIGHT INTENSITY DRIZZLE RAIN
			printf("Weather is: LIGHT INTENSITY DRIZZLE RAIN\n");
			return 0.65;
		}
		if (weather_id == 311) { //DRIZZLE RAIN
			printf("Weather is: DRIZZLE RAIN\n");
			return 0.50;
		}
		if (weather_id == 312) { //HEAVY INTENSITY DRIZZLE RAIN
			printf("Weather is: HEAVY INTENSITY DRIZZLE RAIN\n");
			return 0.40;
		}
		if (weather_id == 313) { //SHOWER RAIN AND DRIZZLE
			printf("Weather is: SHOWER RAIN AND DRIZZLE\n");
			return 0.30;
		}
		if (weather_id == 314) { //HEAVY SHOWER RAIN AND DRIZZLE
			printf("Weather is: HEAVY SHOWER RAIN AND DRIZZLE\n");
			return 0.20;
		}
		if (weather_id == 321) { //SHOWER DRIZZLE
			printf("Weather is: SHOWER DRIZZLE\n");
			return 0.35;
		}
	}
	...
	if ((weather_id >= 500) && (weather_id <= 520) && (wind_incidence_function(wind_direction, time))) {
		if (weather_id == 500) { //LIGHT RAIN
			printf("Weather is: LIGHT RAIN\n");
			return 0.80;
		}
		if (weather_id == 501) { //MODERATE RAIN
			printf("Weather is: MODERATE RAIN\n");
			return 0.70;
		}
		if (weather_id == 502) { //HEAVY INTENSITY RAIN
			printf("Weather is: HEAVY INTENSITY RAIN\n");
			return 0.40;
		}
		if (weather_id == 503) { //VERY HEAVY RAIN
			printf("Weather is: VERY HEAVY RAIN\n");
			return 0.30;
		}
		if (weather_id == 504) { //EXTREME RAIN
			printf("Weather is: EXTREME RAIN\n");
			return 0.10;
		}
		if (weather_id == 511) { //FREEZING RAIN
			printf("Weather is: FREEZING RAIN\n");
			return 0;
		}
		if ((weather_id >= 520) && (weather_id <= 531)) { //LIGHT INTNENSITY SHOWER RAIN/SHOWER RAIN/RAGGED SHOWER RAIN
			printf("Weather is: LIGHT INTENSITY SHOWER RAIN/SHOWER RAIN/RAGGED SHOWER RAIN\n");
			return 0;
		}
	}
	printf("Weather is: NOT DEFINED\n");
	return 1;
}